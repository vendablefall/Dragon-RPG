...
public class SpinMe : MonoBehaviour {
	...
	void Update () {
		// xDegreesPerFrame = Time.DeltaTime, 60, 360, xRotationsPerMinute
			// degrees frame^-1 = (degrees / frame)
		// degrees frame^-1 = seconds frame^-1, seconds minute^-1, degrees Rotation^-1, xRotationsPerMinute
		// seconds frame^-1 / seconds minute^-1 = frame^-1 minute
		// degrees frame^-1 = seconds frame^-1 / seconds minute^-1 * degrees Rotation^-1 * xRotationsPerMinute
		// 
